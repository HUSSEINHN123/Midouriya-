...
module.exports = {
	...
	langs: {
		...
		en: {
			invalidDateFormat: "الرجاء إدخال تاريخ صالح على هذا DD/MM/YYYY الشكل",
			error: "حدث خطأ أثناء الحصول على صورة القمر %1",
			invalidDate: "%1 هذا ليس تاريخ صحيح",
			caption: "- صورة القمر على %1"
		}
	},
