module.exports = {
	config: {
		...
		shortDescription: {
			...
			en: "تشغيل/إيقاف تحذير الكلمات السيئة"
		},
		longDescription: {
			vi: "Bật/tắt/thêm/xóa cảnh báo vi phạm từ thô tục, nếu thành viên vi phạm sẽ bị cảnh báo, lần 2 sẽ kick khỏi box chat",
			en: "تشغيل/إيقاف/إضافة/إزالة تحذير الكلمات السيئة، إذا خالف أحد الأعضاء سيتم تحذيره، وفي المرة الثانية سيتم طرده من مجموعة الدردشة"
		},
		category: "المجموعة",
		guide: {
			vi: "   {pn} add <words>: thêm từ cấm (có thể thêm nhiều từ cách nhau bằng dấu phẩy \",\" hoặc dấu gạch đứng \"|\""
				...
				+ "\n   {pn} on: tắt cảnh báo"
				+ "\n   {pn} off: bật cảnh báo",
			en: "   {pn} إضافة <الكلمة>: إضافة الكلمات المحظورة (يمكنك إضافة كلمات متعددة مفصولة بفواصل \",\" أو أشرطة عمودية \"|\")"
				+ "\n   {pn} مسح <الكلمة>: حذف الكلمات المحظورة (يمكنك حذف كلمات متعددة مفصولة بفواصل \",\" أو أشرطة عمودية \"|\")"
				+ "\n   {pn} قائمة <قم بإخفاء أو | اتركه فارغا>: إيقاف التحذير (إضافة \"إخفاء\" لإخفاء الكلمات المحظورة)"
				+ "\n   {pn} عدم_التحذير [<آيدي المستخدم> | <@تاغ>]: قم بإزالة 1 تحذير واحد للعضو واحد "
				+ "\n   {pn} إيقاف: إيقاف التحذير"
				+ "\n   {pn} تشغيل: قم بتشغيل التحذير"
		}
	},
	...
	langs: {
		...
		en: {
			...
			addedSuccess: "✅ | تمت الإضافة %1 الكلمات المحظورة إلى القائمة",
			...
			onlyAdmin3: "⚠️ | يمكن للمسؤولين فقط %1 إستخدام هذه الميزة",
			turnedOnOrOff: "✅ | تم تحذير الكلمات المحظورة %1",
			onlyAdmin4: "⚠️ | يمكن للمسؤولين فقط حذف تحذير الكلمات المحظورة",
			missingTarget: "⚠️ | أنت لم تدخل آيدي المستخدم أو المستخدم الذي تمت منشنته",
			...
			needAdmin: "يحتاج البوت إلى أن يكون المسؤول لطرد الأعضاء المحظورين",
			unwarned: "✅ | تمت إزالة  الكلمات المحظورة للمستخدم %1 | %2"
		}
	},
