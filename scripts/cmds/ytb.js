...
module.exports = {
	config: {
		...
		longDescription: {
			...
			en: "قم بتحميل فيديو من اليوتيوب أو أغنية أو لتعرف المعلومات"
		},
		category: "وسائط",
		guide: {
			vi: "   {pn} [فيديو|-مقطع] [<tên video>|<link video>]: dùng để tải video từ youtube."
				...
				+ "\n    {pn} -a Fallen Kingdom"
				+ "\n    {pn} -i Fallen Kingdom",
			en: "   {pn} [فيديو|-مقطع] [<مقطع>|<فيديو الرابط>]: تستخدم لتحميل المقاطع من يوتيوب."
				+ "\n   {pn} [أغنية|-موسيقى] [<إسم الأغنية>|<رابط الأغنية>]: من أجل تحميل الأغنية من يوتيوب"
				+ "\n   {pn} [معلومات|-بيانات] [<إسم الفيديو>|<رابط الفيديو>]: يستعمل من أجل رؤية معلومات الفيديو من اليوتيوب"
				+ "\n   مثال:"
				+ "\n    {pn} -مقطع fifty fifty copied"
				+ "\n    {pn} -موسيقى what if "
				+ "\n    {pn} -معلومات 7 years old"
		}
	},
	...
	langs: {
		...
		en: {
			error: "❌ |حدث خطأ أثناء نحميل الفيدو : %1",
			noResult: "⭕ | لاتوجد أي نتيجة تطابق كلمة بحثك %1",
			choose: "%1قم بالرد بالرقم من أجل تحميل الفيدو ومشاهدته",
			video: "فيديو",
			audio: "أغنية",
			downloading: "⬇️ | جاري تحميل %1 \"%2\" يرجى الإنتظار......",
			downloading2: "⬇️ جاري تحميل %1 \"%2\"\n🔃 السرعة: %3 ميغابايت في الثانية\n⏸️ تم التحميل: %4/%5 ميغابايت (%6%)\n⏳ الوقت المقدر المتبقي : %7 ثانية",
			noVideo: "⭕ |عذرًا، لم يتم العثور على أي فيديو بحجم أقل من 83 ميجابايت",
			noAudio: "⭕ |عذرًا، لم يتم العثور على أي أغنية بحجم أقل من 26 ميجابايت",
			info: "💠 العنوان : %1\n🏪 القناة : %2\n👨‍👩‍👧‍👦 عدد المشتركون : %3\n⏱ مدة الفيدو : %4\n👀 عدد المشاهدات : %5\n👍 عدد الايكات : %6\n🆙 تاريخ الرفع : %7\n🔠 الآيدي : %8\n🔗 الرابط : %9",
			listChapter: "\n📖 عدد الفصول : %1\n"
		}
	},
