...
module.exports = {
	config: {
		...
		longDescription: {
			...
			en: 'قم بإضافة ردود إلى المحموعة الخلصة بك'
		},
		category: 'النظام',
		guide: {
			vi: '   {pn} إضافة <كلمة> => <المحتوى>: thêm một phím tắt cho bạn (có thể gửi kèm hoặc phản hồi một tin nhắn có file để thêm tệp đính kèm)'
			...
			en: '   {pn} إضافة <كلمة> => <المحتوى>: قم بإضافة رد من أجلك (يمكنك إرسال رد مع مرفق)'
				+ '\n   مثال:\n    {pn} إضافة السلام عليكم => وعليكم السلام ورحمة الله وبركاته'
				+ '\n'
				+ '\n   {pn} حذف <الكلمة>: قم بحذف الرد'
				+ '\n   مثال :\n    {pn} حذف أهلا'
				+ '\n'
				+ '\n   {pn} إزالة : قم بإزالة كل الردود في مجموعتك'
				+ '\n'
				+ '\n   {pn} قائمة : قم بالإطلاع على قائمة الردود'
				+ '\n   {pn} القائمة بدأ <الكلمة>: قم برؤية الكلمة مع الرد  <للكلمة>'
				+ '\n   {pn} قائمة النهاية <الكلمة>: قم بروية الرد على الكلمة <للكلمة المعطاة>'
				+ '\n   {pn} قائمة المحتوى <الكلمة>: قم بالإطلاع على الردود مع المحتوى <الكلمة>'
		}
	},
	...
	langs: {
		...
		en: {
			missingContent: ' ⚠️ | أرحوك قم بإدخال الرسالة',
			shortcutExists: ' ⚠️ |» الكلمة  "%1" هي بالفعل موحودة ، قم بالتفاعل مع هذه الرسالة بإيموجي من أحل إستبدالها بهذه الكلمة ',
			shortcutExistsByOther: ' ⚠️ |» الرد  %1 تم إضافته من قبل الأعضاء  ، المرجو تحربة رد آخر',
			added: ' ✅ | تمت إضافة الرد %1 => %2',
			addedAttachment: ' 🖼️ | مع %1 من المرفقات/المرفق ',
			missingKey: ' ❌ | قم بإدخال الرد اللذي تريد أن تحذفه',
			notFound: ' ❓ | لم يتم إيجاد رد ل %1 في هذه المحموعة',
			onlyAdmin: ' ⚠️ | فقط آدمنز المجموعة يمكنهم حذف ردود الآخرين',
			deleted: ' ✅ | تم حذف الرد %1',
			empty: ' ❌ |» مجموعتك لم تقم بإضافة رد بعد',
			message: 'رسالة ✉️',
			attachment: 'مرفق 🖼️',
			list: 'إليك قائمة الردود :',
			listWithTypeStart: 'قائمة ردود هذه المجموعة تبدأ ب "%1")',
			listWithTypeEnd: 'قائمة ردود.هذه المجموعة تنتهي ب "%1")',
			listWithTypeContain: 'قائمة ردود هذه المجموعة تحتوى على "%1")',
			listWithTypeStartNot: ' ⚠️ | قائمة الردود الخاصة ليس لديها ردود تنتهي ب "%1"',
			listWithTypeEndNot: ' ⚠️ |»قائمة ردود هذه المجموعة ردودها لا تنتهي ب  "%1"',
			listWithTypeContainNot: ' ⚠️هءه  المجموعة لاتحتوى الردود بها على | "%1"',
			onlyAdminRemoveAll: ' ⚠️ | فقط الآدمن يمكنهم إزاله كل الردود في المجموعة',
			confirmRemoveAll: ' ⚠️ |هل أنت متأكد أنك تريد إزالة كافة الردود في هذه المجموعة ؟ (تفاعل مع هذه الرسالة للتأكيد)',
			removedAll: ' ✅ | تم حذف كل الردود في هذه المجموعة بنجاح '
		}
	},
