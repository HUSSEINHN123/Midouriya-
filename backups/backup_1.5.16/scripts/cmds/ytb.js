...
module.exports = {
	config: {
		...
		countDown: 5,
		role: 0,
		shortDescription: "وسائط",
		longDescription: {
			vi: "Tải video, audio hoặc xem thông tin video trên YouTube",
			en: "قم بتنزيل الفيديو أو الأغنية أو عرض معلومات الفيديو على يوتيوب"
		},
		category: "وسائط",
		guide: {
			vi: "   {pn} [video|-v] [<tên video>|<link video>]: dùng để tải video từ youtube."
				...
				+ "\n    {pn} -a Fallen Kingdom"
				+ "\n    {pn} -i Fallen Kingdom",
			en: "   {pn} [فيديو|مقطع] [<إسم الفيديو>|<رابط الفيديو>]: قم بإستعماله من أجل تنزييل الفيديو من يوتيوب."
				+ "\n   {pn} [أغنية|موسيقى] [<إسم الأغنية>|<رابط الأغنية>]: يستخدم من أجل تنزيل أغنية عبر الرابط او تنزيله لسماعه من يوتيوب"
				+ "\n   {pn} [معلومات|بيانات] [<إسم الفيديو>|<رابط الفيديو>]: يستخدم لترى معلومات حول الفيديو على يوتيوب"
				+ "\n   مثال :"
				+ "\n    {pn} فيديو/مقطع Fallen Kingdom"
				+ "\n    {pn} أغنية/موسيقى fifty fifty copied "
				+ "\n    {pn} معلومات/بيانات prefect love"
		}
	},
	...
	langs: {
		...
		en: {
			error: "❌ | حدث خطأ في : %1",
			noResult: "⭕ |لا توجد اي نتيجة تطابق كلمة بحثك  %1",
			choose: " ⚠️ | %1 قم بالرد بالرقم على الرسالة أعلاه من أجل تنزبل الفيديو او الأغنية ",
			video: "فيديو",
			audio: "الأغنية",
			downloading: " ⏱️ | جاري تنزيل %1 \"%2\" يرجى الإنتظار......",
			downloading2: " ⏱️ | جاري تحميل  %1 \"%2\"\n🔃 السرعة : %3ميغابايت في الثانية\n⏸ تم التحميل √ : %4/%5 ميغابايت (%6%)\n⏳ الوقت المقدر المتبقي: : %7 ثانية/ثواني",
